...
const originalThresholds = {
    rotationJitterThreshold: ReactiveVisualizerInspector.rotationJitterThreshold,
    rotationStillnessTolerance: ReactiveVisualizerInspector.rotationStillnessTolerance,
    audioSpikeThreshold: ReactiveVisualizerInspector.audioSpikeThreshold,
    audioStillnessTolerance: ReactiveVisualizerInspector.audioStillnessTolerance,
    intervalWarningMs: ReactiveVisualizerInspector.intervalWarningMs
};
...
ReactiveVisualizerInspector.rotationJitterThreshold = 0.2;
ReactiveVisualizerInspector.audioSpikeThreshold = 0.3;

const baselineContinuity = ReactiveVisualizerInspector.inspectAndReport('continuity-test', { rot4dXW: 0.1 }, {
    audioReactive: { energy: 0.2 }
});

assert.equal(baselineContinuity.continuity.hasPrevious, false, 'Initial continuity sample should not report previous frame data');
...
Object.entries(originalThresholds).forEach(([key, value]) => {
    ReactiveVisualizerInspector[key] = value;
});
