...
**Next Command**: Extend metadata-aware timeline defaults into choreography import/export routines and broaden automated tests to cover geometry presets + multi-system sequence insertion.
