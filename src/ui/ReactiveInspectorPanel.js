...
export function installReactiveInspectorPanel({
    ...
    controls.append(pauseBtn, copyBtn, clearBtn, sampleWrapper);
    ...
    footer.textContent = 'Tip: Append ?inspectorPanel=1 to enable this overlay automatically. Use Pause/Copy/Clear to manage telemetry.';
