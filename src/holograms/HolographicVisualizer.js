...
export class HolographicVisualizer {
    ...
    render() {
        ...
        const reactiveIntensity = clamp(baseIntensity * (1 + audioResponse.intensity), 0, 3);
        ...
        const baseColorShiftDegrees = (this.roleParams.colorShift || 0) + (this.variantParams.hue || 0);
        const totalColorShift = (baseColorShiftDegrees + (audioResponse.colorShift || 0)) % 360;
